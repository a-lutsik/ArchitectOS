...
class ArchitectOSE2ETests(unittest.TestCase):
    ...
    def test_startup_scripts_configuration_docs_and_help_are_consistent(self) -> None:
        ...
        self.assertNotIn("workspace-tasks", app_js)
        self.assertNotIn('"view.graph"', app_js)
        self.assertNotIn('"view.workflows"', app_js)
        self.assertNotIn("loadWorkflows", app_js)
        self.assertIn("System Workspace", app_js)
        self.assertIn("displayProjectName", app_js)
        self.assertIn("syncProjectTerminology", app_js)
        self.assertIn("browseProjectFolder", app_js)
        self.assertIn("/api/system/folder-picker", app_js)
        self.assertIn("Scan Workspace", app_js)
        self.assertIn("scheduleGraphLoad", app_js)
        self.assertIn("/api/memory/files", app_js)
        self.assertIn("ensureVoiceRecognition", app_js)
        self.assertIn("saveVoiceMemory", app_js)
        self.assertIn("voiceRecognitionLanguage", app_js)
        self.assertIn("/api/code/languages", app_js)
        self.assertIn("/api/code/diagnostics", app_js)
        self.assertIn("/api/code/references", app_js)
        self.assertIn("fillCodeFileFromSelection", app_js)
        self.assertIn("/api/terminal/run", app_js)
        self.assertIn("/api/terminal/open", app_js)
        self.assertIn("runTerminalCommand", app_js)
        self.assertIn("data-terminal-install-run", app_js)
        self.assertIn("data-terminal-install-copy", app_js)
        self.assertIn("data-agent-install-command", app_js)
        self.assertIn("code-server-card", app_js)
        self.assertIn("install-actions", app_js)
        self.assertIn("runInstallCommandInTerminal", app_js)
        self.assertIn("installCodeLanguageServer", app_js)
        self.assertIn("/api/code/servers/", app_js)
        self.assertIn("copyInstallCommand", app_js)
        self.assertIn("askAgentInstallCommand", app_js)
        self.assertIn("LANGUAGE_META", app_js)
        self.assertIn("syncLanguageMenu", app_js)
        self.assertIn("openGraphNodeModal", app_js)
        self.assertIn("graphNodeRelatedFiles", app_js)
        self.assertIn("graphEdgeLabel", app_js)
        self.assertIn("confidence", app_js)
        self.assertIn("translations", app_js)
        self.assertIn("RTL_LANGUAGES", app_js)
        self.assertIn("Русский", app_js)
        self.assertIn("Українська", app_js)
        self.assertIn("עברית", app_js)
